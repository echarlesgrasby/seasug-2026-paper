...
#--------------------------------------------------------------------------------
#Purpose     :
#    This module defines the interface between the AST & symbol table and the transpiled SAS output
#Notes       :
#    The CodeGenerator is an abstract base class that any transpiler target class
#    (e.g. sas_code_generator.py) inherits from
#
#Version     : 0.1.0
...
class CodeGenError(Exception):
    ...
    semantically valid cannot be converted to output code"""
...
class NullCodeGenerator(CodeGenerator):
    """Placeholder implementation, this just stubs out "code" 
    in the form of SAS comments"""
